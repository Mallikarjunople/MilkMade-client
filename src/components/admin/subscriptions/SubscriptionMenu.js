...
import { filterSubscription } from "./Actions";
    ...
    <Fragment>
      <div className="col-span-1 flex items-center">
        <div className="flex flex-col space-y-4 md:flex-row md:justify-between md:items-center md:space-y-0 w-full">
          {/* It's open the add subscription modal */}
          <div
          ...
          >
            ...
            >
              <span
                onClick={(e) =>
                  filterSubscription("All", data, dispatch, dropdown, setDropdown)
                }
              ...
              <span
                onClick={(e) =>
                  filterSubscription("Shipped", data, dispatch, dropdown, setDropdown)
                }
                className="px-4 py-2 hover:bg-black text-center cursor-pointer"
              >
                Shipped
