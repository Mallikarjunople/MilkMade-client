...
const UpdateSubscriptionModal = (props) => {
  ...
  useEffect(() => {
    setOid(data.updateSubscriptionModal.oId);
    setStatus(data.updateSubscriptionModal.status);
  }, [data.updateSubscriptionModal.modal]);
  ...
  return (
    <Fragment>
      ...
      <div
        ...
        className={`${
          data.updateSubscriptionModal.modal ? "" : "hidden"
